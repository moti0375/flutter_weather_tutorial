...
mixin _$WeatherStore on _WeatherStore, Store {
  ...
  final _$getWeatherDetailsAsyncAction =
      AsyncAction('_WeatherStore.getWeatherDetails');

  @override
  Future<void> getWeatherDetails(String cityName) {
    return _$getWeatherDetailsAsyncAction
        .run(() => super.getWeatherDetails(cityName));
  }
